      ...
      return (
        <Page go={go} route={route} title={ROUTE_TITLES[route]}
          ...
          <Card title="Gaps in the data"><Prose>
            ...
            <H>Interconnection wait is a placeholder</H>
            <p>The wait to energize a large load is argued on the home page as the driver that binds hardest in 2026, and the figures currently carried for it are placeholders rather than a queue pull. Carrying a placeholder next to that argument is uncomfortable, and it stays on the page because the alternative is quietly dropping the driver.</p>
